...
export class AuthService{
    ...
    signup(name:string, sname:string, email:string, password:string){
        ...
        ('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCSCEgiIGpq36T8Da_hn_GUty-dkL8eyP8',
        {
            name:name,
            sname:sname,
            email: email,
    ...
    login(email:string, password:string){
        return this.http
         ...
         ('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCSCEgiIGpq36T8Da_hn_GUty-dkL8eyP8',
         { 
            email: email,
            password: password,
            returnSecureToken: true
